...
def main() -> None:
    try:
        ...
        print("進度: market_indices.csv 載入完成")
        data2 = load_csv(DATA_DIR / "vix_index.csv")
        print("進度: vix_index.csv 載入完成")
        data3 = load_csv(DATA_DIR / "futures_chip.csv")
        print("進度: futures_chip.csv 載入完成")
        data4 = load_csv(DATA_DIR / "margin_and_legal.csv")
        print("進度: margin_and_legal.csv 載入完成")
        print("進度: 所有資料載入完成")
